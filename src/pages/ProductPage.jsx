      ...
      <div className="max-w-7xl mx-auto md:px-6 md:py-8">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12">
          ...
          <div className="flex flex-col gap-3 md:gap-5 px-4 md:px-0 mt-4 md:mt-0">
            ...
            {/* Compact delivery/return/care accordion */}
            <div className="border-t border-[#f0ede8]">
              <button
                type="button"
                onClick={() => setAccordionOpen((v) => !v)}
                className="flex w-full items-center justify-between py-3 text-sm text-gray-700 hover:text-gray-900 transition-colors"
              >
                ...
                <ChevronDown className={`w-4 h-4 text-gray-400 transition-transform flex-shrink-0 ${accordionOpen ? 'rotate-180' : ''}`} />
              </button>
              {accordionOpen && (
                <div className="pb-3 text-sm text-gray-600 space-y-2">
