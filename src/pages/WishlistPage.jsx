...
export default function WishlistPage() {
  ...
  if (loading) {
    return (
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 md:py-12">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900 md:text-3xl">Избранное</h1>
          <p className="mt-2 text-sm text-gray-500">Сохраняйте понравившиеся товары и возвращайтесь к ним позже</p>
        </div>
        <WishlistSkeleton />
      </div>
    )
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 md:py-12">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900 md:text-3xl">Избранное</h1>
        <p className="mt-2 text-sm text-gray-500">Ваши сохранённые модели Capriccio</p>
      </div>
